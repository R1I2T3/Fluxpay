...
export const statusText=(status:string)=>({DRAFT:'Saved draft',QUOTED:'Ready to send',PROCESSING:'Processing',UNDER_REVIEW:'Under review',COMPLETED:'Completed',FAILED:'Unsuccessful',REJECTED:'Declined',REFUNDED:'Refunded',CANCELLED:'Cancelled'} as Record<string,string>)[status]||status||'Status unavailable';
