...
public class Payment {
  ...
  @Column(name = "current_quote_generation")
  private Integer currentQuoteGeneration;

  @Column(name = "quote_generation_counter")
  ...
  @Lob
  @Column(name = "posting_snapshot")
  private String postingSnapshot;

  @Column(name = "posted_at")
  private Instant postedAt;

  @Column(name = "review_reference")
  ...
  public int eventSequenceCounter() {
    return eventSequenceCounter;
  }

  public String postingSnapshot() {
