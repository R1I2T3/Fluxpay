-- V703: Member 5 seed data, after the M2 required wallet-role migration.
...
INSERT INTO wallets (id, user_id, currency, balance, account_role, created_at) VALUES
(HEXTORAW('00000000000000000000000000005B01'), HEXTORAW('00000000000000000000000000005A01'), 'USD', 500.00, 'CUSTOMER', SYSTIMESTAMP);

INSERT INTO wallets (id, user_id, currency, balance, account_role, created_at) VALUES
(HEXTORAW('00000000000000000000000000005B02'), HEXTORAW('00000000000000000000000000005A02'), 'USD', 1200.00, 'CUSTOMER', SYSTIMESTAMP);

INSERT INTO wallets (id, user_id, currency, balance, account_role, created_at) VALUES
(HEXTORAW('00000000000000000000000000005B03'), HEXTORAW('00000000000000000000000000005A03'), 'EUR', 300.00, 'CUSTOMER', SYSTIMESTAMP);
