...
class SeedMigrationContractTest {
  ...
  void seedsTransferProvidersWithInsertOnlyMerges() throws IOException {
    ...
    assertThat(sql)
        ...
        .contains("'FLUXPAY'")
        .contains("'DEMO_BANK_ALPHA'")
        .contains("'DEMO_REAL_TIME'")
        .contains("'DEMO_PARTNER'")
  ...
  void seedsTransferRoutesWithInsertOnlyMerges() throws IOException {
    ...
    assertThat(sql)
        ...
        .contains("'DEMO_BANK_STANDARD'")
        .contains("'DEMO_BANK_EXPRESS'")
        .contains("'DEMO_REALTIME_INR'")
        .contains("'DEMO_PARTNER_INR'")
